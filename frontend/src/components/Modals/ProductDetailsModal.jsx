    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <div className="space-y-4 mb-6">
          <div>
            <h3 className="text-sm text-gray-600 font-semibold">Nombre del Producto</h3>
            <p className="text-lg text-gray-900 font-bold">{product.ProductName}</p>
          </div>

          <div>
            <h3 className="text-sm text-gray-600 font-semibold">Código de Barras</h3>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h3 className="text-sm text-gray-600 font-semibold">Categoría</h3>
              <p className="text-gray-900">
                {product.CategoryName || 'Sin categoría'}
              </p>
            </div>
            <div>
              <h3 className="text-sm text-gray-600 font-semibold">Stock</h3>
              <p className={`font-bold ${
                product.StockQuantity > 10 ? 'text-green-600' :
                product.StockQuantity > 0 ? 'text-orange-600' :
                'text-red-600'
              }`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <h3 className="text-sm text-gray-600 font-semibold">Precio de Costo</h3>
              <p className="text-lg text-gray-900 font-bold">
                S/. {parseFloat(product.CostPrice || 0).toFixed(2)}
              </p>
            </div>
            <div>
              <h3 className="text-sm text-gray-600 font-semibold">Precio de Venta</h3>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <h3 className="text-sm text-gray-600 font-semibold">Margen de Ganancia</h3>
          ...
          {product.Description && (
            <div>
              <h3 className="text-sm text-gray-600 font-semibold">Descripción</h3>
          ...
          <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
            <div>
              <h3 className="text-xs text-gray-600 font-semibold">Creado</h3>
              <p className="text-xs text-gray-500">
                {new Date(product.CreatedAt).toLocaleDateString('es-PE')}
              </p>
            </div>
            <div>
              <h3 className="text-xs text-gray-600 font-semibold">Estado</h3>
